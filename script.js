...
function displayAlbums(albumsToDisplay) {
    ...
    albumsToDisplay.forEach(album => {
        ...
        // Получаем имя файла для альбома
        const albumFileName = album.title.toLowerCase().replace(/[^a-zа-я0-9]/g, '');
      ...
      <div class="album-info">
        <h3 class="album-title">
          <a href="pages/albums/${albumFileName}.html" class="album-link">${album.title}</a>
        </h3>
    ...
    `;
        ...
        // Добавляем обработчик события для открытия модального окна при клике на карточку
        albumCard.addEventListener('click', (e) => {
            // Если клик был по ссылке названия, не открываем модальное окно
...
function displaySingles(singlesToDisplay) {
    ...
    singlesToDisplay.forEach(single => {
        ...
        // Получаем имя файла для сингла
        const singleFileName = single.title.toLowerCase().replace(/[^a-zа-я0-9]/g, '');
      ...
      <div class="single-info">
        <h3 class="single-title">
          <a href="pages/singles/${singleFileName}.html" class="album-link">${single.title}</a>
        </h3>
